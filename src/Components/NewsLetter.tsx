...
const NewsLetter = () => {
  return (
        <div className="grid grid-cols-2 gap-5 items-center bg-[#eeeeee] rounded-[24px]  ">
          <div>
            <img src={newsimg} alt="" className="rounded-s-[24px]"/>
          </div>
          <div className="flex justify-center h-full flex-col p-5 pl-0">
        <h4 className="text-[36px] mb-5 ">Become an <span className="font-Dmserif text-[#1c9d41] ">Explorist</span></h4>
